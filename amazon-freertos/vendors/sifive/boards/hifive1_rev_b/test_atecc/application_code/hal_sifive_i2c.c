...
//    atca_delay_us(cfg->wake_delay); // 1500
...
{
	DEBUG_LOG("hal_create_mutex - unimplemented\r\n");
	return ATCA_SUCCESS;
}
ATCA_STATUS hal_destroy_mutex(void * pMutex)
{
	DEBUG_LOG("hal_destroy_mutex - unimplemented\r\n");
	return ATCA_SUCCESS;
}
ATCA_STATUS hal_lock_mutex(void * pMutex)
{
	DEBUG_LOG("hal_lock_mutex - unimplemented\r\n");
	return ATCA_SUCCESS;
}
ATCA_STATUS hal_unlock_mutex(void * pMutex)
{
	DEBUG_LOG("hal_unlock_mutex - unimplemented\r\n");
	return ATCA_SUCCESS;
}
#endif
/** @} */
